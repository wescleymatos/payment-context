...
{
    public class SubscriptionHandle : Notifiable, IHandler<CreateBoletoSubscriptionCommand>
    {
        ...
        public ICommandResult Handle(CreateBoletoSubscriptionCommand command)
        {
            ...
            _emailService.Send(name.ToString(), command.Email, "Assinatura realizada com sucesso", "");
